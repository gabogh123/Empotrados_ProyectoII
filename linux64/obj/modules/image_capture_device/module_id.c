...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1714852330" ";"
	"MOD:" "image_capture_device" ";"
	"CLS:image_capture_device" ";"
	"HOSTTYPE:" "linux64" ";"
	"THREADSAFE;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Sat May  4 15:52:10 2024";
extern void _initialize_image_capture_device_dml(void);
...
_simics_module_init(void)
{
	...
	_initialize_image_capture_device_dml();
	init_local();
}
