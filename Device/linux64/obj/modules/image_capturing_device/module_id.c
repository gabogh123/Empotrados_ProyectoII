...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1714885222" ";"
	"MOD:" "image_capturing_device" ";"
	"CLS:image_capturing_device" ";"
	"HOSTTYPE:" "linux64" ";"
	"THREADSAFE;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Sun May  5 01:00:22 2024";
extern void _initialize_image_capturing_device_dml(void);
...
_simics_module_init(void)
{
	...
	_initialize_image_capturing_device_dml();
	init_local();
}
