...
import info_status
import simics
import image_capturing_device_common

# Verify that info/status commands have been registered for all
# classes in this module.
info_status.check_for_info_status(['image_capturing_device'])

# Create an instance of each object defined in this module
dev = image_capturing_device_common.create_image_capturing_device()
